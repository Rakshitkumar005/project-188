...
firebase = firebase.FirebaseApplication("https://kwitter-new-7ee2b-default-rtdb.firebaseio.com", None)
...
def login_window():
    ...
    login_heading_lbl = Label(login_window, text = "Log In", font = 'arial 18 bold', fg = "black", bg = "orange")
    login_heading_lbl.place(relx = 0.5, rely = 0.3, anchor = CENTER)
    
    login_username_lbl = Label(login_window, text = "Username :", font = 'arial 13', bg = "orange", fg = "black")
    ...
    login_password_lbl = Label(login_window, text = "Password :", font = 'arial 13', bg = "orange", fg = "black")
